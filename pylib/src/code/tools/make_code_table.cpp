...
{
	fprintf(stderr, "usage: %s [ru] -t table_name <stdin >stdout\n", progname);
	fprintf(stderr, "     : -r, first column is value, second column is key\n");
	fprintf(stderr, "     : -u, unfound character will be trans to '?'\n");
	fprintf(stderr, "     : -t, table name in the new generated cpp file\n");
}
