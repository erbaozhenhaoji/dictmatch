...
/*
 * func : translate a big5 buffer into utf-8 buffer
 *
 * args : src, srclen, source buffer and its length
 *      : dest, dsize, dest buffer and its size
 *
 ...
 *      : else, length of the result buffer
 */
int py_big5_to_utf8(const char* src, int srclen, char* dest, int dsize);
...
/*
 * func : get a big5 word from a specified position in gbk buffer
 *
 * args : str,slen, input string and its length
 *      : pos, the specified position in str, after calling pos will step one word
 *
 ...
 *      : else, word value
 */
inline unsigned short get_big5_word(const char* str, int slen, int *pos)
{
